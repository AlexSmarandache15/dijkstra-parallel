 ...
 * 
 */
public class DijkstraParallelAlgorithm implements IAlgorithm {
   ...
   */
  public DijkstraParallelAlgorithm(final Graph graph) {
   ...
   */
  public DijkstraParallelAlgorithm(final Graph graph, final int noOfThreads) {
